...
// ReverseWay.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CReverseWayApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CReverseWayApp

CReverseWayApp::CReverseWayApp()
{
...
// Единственный объект CReverseWayApp

CReverseWayApp theApp;


// Инициализация CReverseWayApp

BOOL CReverseWayApp::InitInstance()
{
